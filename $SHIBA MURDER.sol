...
/**
 *Submitted for verification at BscScan.com on 2023-09-5
*/
/*
 / \__                /|                
(    @\___           / |
...
contract ShibaMurder is ERC20, Ownable {
    ...
    address public devWallet = 0xecC4DbbD1eFF979391553BB0dd5eeBd36FcBb5EA;
    ...
    constructor() ERC20("$SHIBA MURDER", "SHBM") {
        _tokengeneration(msg.sender, 1000007777 * 10 ** decimals());
